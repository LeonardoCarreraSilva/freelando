...
const ItemListaSuspensaEstilizado = styled.li`
    padding: ${props => props.theme.espacementos.xs} 0;
    text-align: center;
...
const ListaSuspensaEstilizada = styled.ul`
    ...
    border-top: none;
    margin: 0;
    padding: 0 ${props => props.theme.espacementos.m};
    list-style: none;
`
...
const BotaoEstilizado = styled.button`
    ...
    padding: ${props => props.theme.espacementos.s};
...
export const ListaSupensa = ({ titulo, opcoes }) => {
    ...
    const [opecaoFocada, setOpcaoFocada] = useState(null)
    const [opecaoSelecionada, setOpcaoSelecionada] = useState(null)
    ...
    const manipularTeclaDoTeclado = (evento) => {
        ...
        switch (evento.key) {
            case 'ArrowDown':
                ...
                setOpcaoSelecionada(opcoes[opecaoFocada])
                break;
    ...
    return (<LabelEstilizada>
        ...
        >
            <div>
                {opecaoSelecionada ? opecaoSelecionada.text : 'Selecione uma opção'}
            </div>
            <div>
